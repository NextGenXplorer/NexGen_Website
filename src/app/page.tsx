...
export default function Home() {
  return (
    <>
      ...
      <section className="w-full h-screen relative overflow-hidden bg-black/[0.96]">
        {/* Spline 3D Scene */}
        ...
        {/* Content Overlay */}
        <div className="relative z-10 flex items-center justify-center h-full bg-gradient-to-t from-black/60 via-transparent to-transparent">
          <div className="text-center px-8 max-w-4xl">
            <h2 className="text-5xl md:text-7xl font-black font-headline mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-400 animate-in fade-in slide-in-from-bottom-4 duration-700">
              Welcome to the Future
            </h2>
            <p className="text-xl md:text-3xl text-white/80 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-150">
